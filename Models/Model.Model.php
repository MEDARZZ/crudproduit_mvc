<?php
	...
	abstract class Model{
		...
		protected static $db_base='stockProduits';

		public static function connecter()
		{
			$valconn=mysqli_connect(self::$host, self::$user, self::$password,self::$db_base);
			return $valconn;
		}
		...
		public static function getquery_table($table,)
		{
